...
```
Prompt: "Lee docs/tracciona-docs/migracion/00-backup.md (alias de compatibilidad histórica) y ejecuta el backup completo del proyecto."
```

### Sesión 2 — Paso 1: Renombrar tablas + i18n

```
Prompt: "Lee docs/tracciona-docs/migracion/01-pasos-0-6-migracion.md (alias de compatibilidad histórica), sección PASO 1.
También lee docs/tracciona-docs/anexos/T-internacionalizacion-i18n.md (alias de compatibilidad histórica) para entender el sistema i18n.
...
```
Prompt: "Lee docs/tracciona-docs/anexos/V-tablas-placeholder-capa2.md (alias de compatibilidad histórica).
...
También lee docs/tracciona-docs/anexos/W-panel-configuracion.md (alias de compatibilidad histórica) sección W.2 para
...
```
Prompt: "Lee docs/tracciona-docs/migracion/01-pasos-0-6-migracion.md (alias de compatibilidad histórica), sección PASO 2.
También lee docs/tracciona-docs/anexos/T-internacionalizacion-i18n.md (alias de compatibilidad histórica) secciones T.5 y T.6.
...
```
Prompt: "Lee docs/tracciona-docs/migracion/01-pasos-0-6-migracion.md (alias de compatibilidad histórica), sección PASO 3.
...
```
Prompt: "Lee docs/tracciona-docs/migracion/01-pasos-0-6-migracion.md (alias de compatibilidad histórica), sección PASO 4.
También lee docs/tracciona-docs/anexos/P-contenido-editorial.md (alias de compatibilidad histórica) para las rutas de /comunicacion/.
...
```
Prompt: "Lee docs/tracciona-docs/migracion/01-pasos-0-6-migracion.md (alias de compatibilidad histórica), sección PASO 5.
...
```
Prompt: "Lee docs/tracciona-docs/migracion/01-pasos-0-6-migracion.md (alias de compatibilidad histórica), sección PASO 6,
...
```
Prompt: "Lee docs/tracciona-docs/migracion/01-pasos-0-6-migracion.md (alias de compatibilidad histórica), sección PASO 6,
ítems 11 al 20. También lee docs/tracciona-docs/anexos/R-marco-legal.md (alias de compatibilidad histórica) para los disclaimers.
...
```
Prompt: "Lee docs/tracciona-docs/anexos/W-panel-configuracion.md (alias de compatibilidad histórica) completo.
...
```
Prompt: "Lee docs/tracciona-docs/anexos/W-panel-configuracion.md (alias de compatibilidad histórica) secciones W.6.6 a W.6.10.
...
```
Prompt: "Lee docs/tracciona-docs/anexos/W-panel-configuracion.md (alias de compatibilidad histórica) secciones W.4, W.5 y W.7.
...
```
Prompt: "Lee docs/tracciona-docs/anexos/P-contenido-editorial.md (alias de compatibilidad histórica) y
docs/tracciona-docs/anexos/U-publicacion-programada-calendario.md (alias de compatibilidad histórica).
...
4. **Si se pierde contexto** — Nuevo chat, repite "Lee docs/tracciona-docs/README.md (alias de compatibilidad)"
5. **Para dudas de negocio** — "Lee docs/tracciona-docs/contexto-global.md (alias de compatibilidad)"
6. **Para ver por qué se tomó una decisión** — "Lee docs/tracciona-docs/CHANGELOG.md (alias de compatibilidad)"
