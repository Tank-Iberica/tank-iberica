...
const history = ref<
  Array<{ from: VehicleStatus; to: VehicleStatus; reason: string | null; timestamp: string }>
>([])
  ...
  <div class="lifecycle-panel">
    ...
    <div v-if="confirmTarget" class="confirm-form">
      <p class="confirm-title">
        {{
          t('lifecycle.confirmTo', {
            status:
              STATUS_META[confirmTarget].label[$i18n.locale] ?? STATUS_META[confirmTarget].label.es,
          })
        }}
      </p>
