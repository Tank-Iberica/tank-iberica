...
const formattedPrice = computed(() => {
  ...
  return new Intl.NumberFormat('es-ES', { style: 'currency', currency: 'EUR' }).format(props.salePrice)
})
</script>

<template>
  <div class="post-sale-overlay" role="dialog" :aria-label="t('lifecycle.postSale.title')" @click.self="handleClose">
