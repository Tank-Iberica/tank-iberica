...
const showAlert = computed(
  () => !dismissed.value && (expiredCount.value > 0 || expiringSoonCount.value > 0),
)
...
<template>
  <div v-if="showAlert" class="expiry-alert" :class="`alert-${alertLevel}`" role="alert">
    ...
    <div class="alert-actions">
      <NuxtLink :to="`/dashboard/vehiculos?status=expired`" class="alert-btn alert-btn-primary">
