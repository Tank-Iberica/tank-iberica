...
defineProps<{
  ...
  relatedCategoryInput: string
}>()

defineEmits<{
  'update:relatedCategoryInput': [value: string]
  addCategory: []
  ...
  <div class="section">
    ...
    <div class="hashtag-input-row">
      <input
        ...
        :value="relatedCategoryInput"
        @input="$emit('update:relatedCategoryInput', ($event.target as HTMLInputElement).value)"
