      ...
      <table v-else class="health-table" role="table">
        ...
        <tbody>
          <tr v-for="row in filtered" :key="row.id">
            <td>
              <span class="dealer-name">{{ row.company_name || t('admin.dealerHealth.unknown') }}</span>
            </td>
...
.dealer-name { font-weight: 500; color: var(--text-primary); }
...
.score-top      { color: var(--color-success); }
.score-verified { color: #1d4ed8; }
