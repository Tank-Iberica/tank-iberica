...
const emit = defineEmits<{
  ...
  (e: 'update:autoNotifyLeads', value: boolean): void
  (e: 'update:autoRenewListings', value: boolean): void
    ...
    <div class="settings-list">
      ...
      <div class="setting-row">
        ...
        <select
          ...
          :disabled="saving"
          @change="emit('update:listingDurationDays', Number(($event.target as HTMLSelectElement).value))"
        >
          <option
            v-for="days in DURATION_OPTIONS"
            :key="days"
            :value="days"
          >
...
.toggle:checked { background: var(--color-primary, #23424A); }
