  ...
  <div class="cal-root">
    ...
    <div class="cal-toolbar">
      <div class="cal-nav">
        ...
        <button class="cal-btn cal-btn-icon" :aria-label="t('admin.social.calendar.prev')" @click="goBack">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <polyline points="15 18 9 12 15 6" />
          </svg>
        </button>
        <button class="cal-btn cal-btn-icon" :aria-label="t('admin.social.calendar.next')" @click="goForward">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <div v-if="selectedPost" class="cal-drawer-overlay" @click.self="closePost">
        <div class="cal-drawer" role="dialog" :aria-label="t('admin.social.calendar.postDetail')">
          ...
          <div class="cal-drawer-content">
            <p>{{ selectedPost.content?.es || selectedPost.content?.en || t('admin.social.calendar.noContent') }}</p>
          </div>
          ...
          <div v-if="selectedPost.external_post_id" class="cal-drawer-ext">
            <small>{{ t('admin.social.calendar.externalId') }}: {{ selectedPost.external_post_id }}</small>
          </div>
        </div>
      </div>
    </Transition>
...
.cal-btn:hover { background: var(--bg-hover, #f3f4f6); }
.cal-btn:focus-visible { outline: 2px solid var(--color-primary, #23424a); outline-offset: 2px; }
...
.cal-btn-icon { padding: 6px; min-width: 34px; }
...
.cal-drawer-close:hover { background: var(--bg-hover, #f3f4f6); }
...
@media (max-width: 640px) {
  ...
  .cal-period-label { font-size: 0.8125rem; }
