 ...
 * Extracts all page-level logic from admin/productos/index.vue
 * Handles sorting, filtering, column config, modals, exports, and selection.
 */
...
export function useAdminProductosPage() {
  ...
  // --- Init & Cleanup (no onMounted inside composable) -------------------
