...
.card-below .summary-card__count { color: var(--color-success); }
.card-above .summary-card__count { color: var(--color-error); }
.card-at .summary-card__count    { color: var(--color-primary, #23424A); }
.card-avg .summary-card__count   { color: var(--text-primary); }
...
.pos-below  { color: #065f46; background: #d1fae5; }
.pos-above  { color: #991b1b; background: #fee2e2; }
.pos-average { color: #1e40af; background: #dbeafe; }

.deviation-cell.pos-below  { color: var(--color-success); font-weight: 600; }
.deviation-cell.pos-above  { color: var(--color-error); font-weight: 600; }
...
.suggestion-item.pos-below  { background: #f0fdf4; border-color: var(--color-success); color: #14532d; }
.suggestion-item.pos-above  { background: #fef2f2; border-color: var(--color-error); color: #7f1d1d; }
.suggestion-item.pos-average { background: var(--bg-secondary); border-color: var(--color-primary, #23424A); color: var(--text-primary); }
