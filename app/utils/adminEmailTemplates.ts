...
export function getSampleValue(varName: string): string {
  const samples: Record<string, string> = {
    ...
    renewal_url: `${useSiteUrl()}/mi-cuenta/suscripcion`,
    retry_date: '18/02/2026',
    update_payment_url: `${useSiteUrl()}/mi-cuenta/pago`,
    effective_date: '28/02/2026',
    verification_level: 'Verificado',
    auction_title: 'Subasta Cisterna ADR Febrero 2026',
    auction_url: `${useSiteUrl()}/subastas/cisterna-adr-feb-2026`,
    ...
    article_url: `${useSiteUrl()}/noticias/normativas-adr-2026`,
    article_summary: 'Las nuevas normativas ADR que entran en vigor...',
    buyer_name: 'Ana Lopez',
    search_url: `${useSiteUrl()}/catalogo`,
    alert_name: 'Cisternas > 30.000L',
    match_count: '4',
    results_url: `${useSiteUrl()}/catalogo?alert=123`,
    old_price: '45.000 EUR',
    new_price: '42.500 EUR',
    similar_url: `${useSiteUrl()}/catalogo?similar=abc`,
    demand_summary: 'Cisterna ADR 30.000L, max 5 anos, < 50.000 EUR',
    demand_id: 'DEM-2026-0042',
    current_bid: '35.000 EUR',
    your_bid: '33.000 EUR',
    next_steps_url: `${useSiteUrl()}/subastas/ganador/abc`,
    user_name: 'Usuario',
    confirmation_url: `${useSiteUrl()}/confirmar?token=abc123`,
    reset_url: `${useSiteUrl()}/reset?token=abc123`,
