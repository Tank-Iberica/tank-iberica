...
function makeSupabase(opts: {
  ...
  const {
    expired = [
      { id: 'v1', dealer_id: 'd1', make: 'Volvo', model: 'FH', year: 2018, published_at: '2025-01-01T00:00:00Z' },
      { id: 'v2', dealer_id: 'd1', make: 'MAN', model: 'TGX', year: 2019, published_at: '2025-01-02T00:00:00Z' },
    ],
    expiredError = null,
    updateError = null,
