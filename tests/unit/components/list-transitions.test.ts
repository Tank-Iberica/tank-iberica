...
const FILES = {
  ...
  comparadorContent: readFileSync(resolve(ROOT, 'app/components/perfil/comparador/ComparadorContent.vue'), 'utf-8'),
  catalogActiveFilters: readFileSync(resolve(ROOT, 'app/components/catalog/CatalogActiveFilters.vue'), 'utf-8'),
