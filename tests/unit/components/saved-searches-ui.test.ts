...
describe('Saved searches (alertas) UI', () => {
  describe('Components exist', () => {
    ...
    it('AlertEditModal component exists', () => {
      expect(existsSync(resolve(ROOT, 'app/components/perfil/alertas/AlertEditModal.vue'))).toBe(true)
    })
  ...
  describe('AlertEditModal', () => {
    const modal = readFileSync(resolve(ROOT, 'app/components/perfil/alertas/AlertEditModal.vue'), 'utf-8')
