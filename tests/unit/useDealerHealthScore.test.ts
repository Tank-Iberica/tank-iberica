...
describe('score ranges', () => {
  it('max score across all dimensions is 100', () => {
    ...
    const sum =
      maxBreakdown.photosScore +
      maxBreakdown.descriptionScore +
      maxBreakdown.responseScore +
      maxBreakdown.priceUpdateScore +
      maxBreakdown.profileScore +
      maxBreakdown.vehiclesScore
    expect(sum).toBe(100)
  })
