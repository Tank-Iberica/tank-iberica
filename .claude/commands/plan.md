...
5. **Páginas/componentes**: ¿Qué archivos Vue crear o modificar?
6. **i18n**: ¿Qué claves añadir a i18n/es.json?
7. **Edge cases**: Errores, permisos, validación, mobile
8. **Estimación**: Simple (1h) / Media (2-4h) / Compleja (4-8h)

NO escribas código. Solo el plan.

Usa Sequential Thinking para razonar paso a paso.
